            ...
            util: {
                ...
                isAemEditMode: function () {
                    ...
                    if (
                        ...
                        win.frameElement &&
                        $(win.parent.document)
                            .find('.foundation-authoring-ui-mode')
                            .size()
                    ) {
                        flag = true;
                    }
                    ...
                    if (this.isIOS) {
                        ...
                        var focusClass = 'find-focus-element',
                            focusElements =
                                '<span class="' +
                                focusClass +
                                '" style="position:fixed;left:0;right:0;width:1px;height:1px;font-size:1px;line-height:0;color:transparent;outline:none">&nbsp;</span>';
